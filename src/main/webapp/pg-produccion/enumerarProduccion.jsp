...
%>
--%>
<jsp:useBean id="fachada3" class="appnomina.negocio.facade.ProduccionFacade"></jsp:useBean>
    <html>
            ...
            <script>
                $("button").click(function () {
                    ...
                    $("#boxInsertar").load(verificarPaginaP($(this).val()), function () {
                    });
                });
            </script>
        </head>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="tablaProduccions1" class="table table-bordered">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Nombre</th>
                ...
                <tbody>
                    <% for (Produccion produccion : fachada3.buscarProducciones()) {
                    %>
                    <tr>                               
