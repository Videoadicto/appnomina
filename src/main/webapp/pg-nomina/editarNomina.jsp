            ...
            <script>
                ...
                $(document).ready(function () {
                    $("#btnGuardar").click(function () {
                        $("#boxEditar").load("pg-nomina/guardarNomina.jsp?" + (validarDatosEdicion(nuevo = 0)), function () {
                        });
                    });
                });
            </script>
        ...
        <div class="card-body">
            ...
            <form id="frmRegistrar" name="frmRegistrar">
                ...
                <div class="form-group">
                    ...
                    <button type="button" value="pg-nomina/listarNomina.jsp?mens=0" class="btn btn-success">Regresar</button>
                </div>
