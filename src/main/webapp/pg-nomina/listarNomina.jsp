...
<jsp:useBean id="fachada" class="appnomina.negocio.facade.EmpleadoFacade"></jsp:useBean>
    <html>
        ...
        <div class="card-header" style="background-color: rgb(75, 131, 145);height:50px;">,
            <h1 style="font-family: 'Dyuthi';font-size: 40px; color: rgb(255, 255, 255);top: -30px; position:relative;">NOMINA</h1>
        </div>
        ...
        <button class="btn" id="nuevo" value="pg-nomina/insertarNomina.jsp" style="background:rgb(0, 195, 255);left : 1.2%; position:relative;">
            ...
            <table id="tablaEmpleados" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>                               
                        ...
                        <td>
                            <button  class="item" style="border:none" value="pg-nomina/editarNomina.jsp?cedula=<%= empleado.getCedula()%>">
                                <img src="img/editar.png" width="16" height="16" >
                            </button>

                            <button  class="item" style="border:none" value="pg-nomina/mostrarNomina.jsp?cedula=<%= empleado.getCedula()%>">
                            ...
                            <button  class="item" style="border:none" value="pg-nomina/eliminarNomina.jsp?cedula=<%= empleado.getCedula()%>">
