...
<jsp:useBean id="fachadaP" class="appnomina.negocio.facade.ProveedorFacade"></jsp:useBean>
    <html>
        ...
        <tr>
            ...
            <th>
                <div>
                    <button class="btn" id="btnCompras" style="background:rgb(0, 195, 255)">
            ...
            <th>
                <div>
                    <button class="btn" id="btnVentas" style="background:rgb(0, 195, 255)">
                        <i class="fa fa-toolbox" >
                        </i> Informe de Ventas
                    </button>
                </div>
            ...
            <th>
                <div>
                    <button class="btn" id="btnProveedor" style="background:rgb(0, 195, 255)">
                        <i class="fa fa-toolbox" >
