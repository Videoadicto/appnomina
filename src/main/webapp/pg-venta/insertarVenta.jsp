...
<%@page import="appnomina.capadatos.entidades.Categoria"%>
...
<html>
    <head>
        <jsp:useBean id="fachada2" class="appnomina.negocio.facade.VentaFacade" scope="page"></jsp:useBean>
        <jsp:useBean id="fachada" class="appnomina.negocio.facade.ProductoFacade"></jsp:useBean>
        <jsp:useBean id="fachada3" class="appnomina.negocio.facade.ClienteFacade"></jsp:useBean>
        <%--     <jsp:useBean id="fachada2" class="appnomina.negocio.facade.CategoriaFacade"></jsp:useBean> --%>
